...
| Имя             | Роль                       | Отчет |
|-----------------|----------------------------|-------|
| Егор Калугин    | Тимлид-Разработчик         | [Отчет](./reports/egor_kalugin.md) |
| Алина Лукьянова | Тестировщик QA-Разработчик | [Отчет](./reports/alina_lukianova.md) |
| Игорь Барбашов  | Аналитик-Разработчик       | [Отчет](./reports/igor_barbashov.md) |
| Денис Еременко  | Разработчик                | [Отчет](./reports/denis_eremenko.md)  |
